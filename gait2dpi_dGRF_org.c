...
//	Vsurface....Surface velocity at this time   
//   
// Outputs:   
...
//    stick.......X and Y coordinates of 10 points: trunkCM, hip, Rknee, Rankle, Rheel, Rtoe, Lknee, Lankle, Lheel, Ltoe
	...
	double FxLToe;
	double FyLToe;
	double Vsurface = (Vsurfaces[0]+Vsurfaces[1])/2;
	static double z[583];
  z[1] = cos(q3);
  z[2] = sin(q3);
  ...
  ydotRHeel);
  FxRHeel = -par->ContactFric*FyRHeel*(-1+2/(1+exp((Vsurface-xdotRHeel)/
  par->ContactV0)));
  ...
  FxRToe = -par->ContactFric*FyRToe*(-1+2/(1+exp((Vsurface-xdotRToe)/par->ContactV0)));
  ...
  ydotLHeel);
  FxLHeel = -par->ContactFric*FyLHeel*(-1+2/(1+exp((Vsurface-xdotLHeel)/
  par->ContactV0)));
  ...
  FxLToe = -par->ContactFric*FyLToe*(-1+2/(1+exp((Vsurface-xdotLToe)/par->ContactV0)));
  ...
  ydotLToe);
  z[172] = exp((Vsurface-xdotRHeel)/par->ContactV0);
  z[173] = exp((Vsurface-xdotRToe)/par->ContactV0);
  z[174] = exp((Vsurface-xdotLHeel)/par->ContactV0);
  z[175] = exp((Vsurface-xdotLToe)/par->ContactV0);
  ...
  z[56]*FyLToe;
  dgrf_dq[0] = 0;
  dgrf_dq[1] = par->ContactFric*(z[165]*(-1+2/(1+exp((Vsurface-xdotRHeel)/
  par->ContactV0)))+z[167]*(-1+2/(1+exp((Vsurface-xdotRToe)/par->ContactV0))));
  dgrf_dq[2] = -z[204] - z[206];
  dgrf_dq[3] = -z[204] - z[206];
  dgrf_dq[4] = -z[245] - z[247];
  dgrf_dq[5] = -z[266] - z[268];
  dgrf_dq[6] = 0;
  dgrf_dq[7] = 0;
  dgrf_dq[8] = 0;
  dgrf_dq[9] = 0;
  dgrf_dq[10] = -z[165] - z[167];
  dgrf_dq[11] = z[199] + z[202];
  dgrf_dq[12] = z[199] + z[202];
  dgrf_dq[13] = z[240] + z[243];
  dgrf_dq[14] = z[261] + z[264];
  dgrf_dq[15] = 0;
  dgrf_dq[16] = 0;
  dgrf_dq[17] = 0;
  dgrf_dq[18] = FyRHeel + FyRToe;
  dgrf_dq[19] = par->ShankLen*z[18]*z[165] + par->ShankLen*z[18]*z[167] + 
  par->ThighLen*z[8]*z[165] + par->ThighLen*z[8]*z[167] + par->ContactFric*
  par->ShankLen*z[20]*z[165]*(-1+2/(1+exp((Vsurface-xdotRHeel)/par->ContactV0))) + 
  par->ContactFric*par->ShankLen*z[20]*z[167]*(-1+2/(1+exp((Vsurface-xdotRToe)/
  par->ContactV0))) + par->ContactFric*par->ThighLen*z[7]*z[165]*(-1+2/(1+exp((
  Vsurface-xdotRHeel)/par->ContactV0))) + par->ContactFric*par->ThighLen*z[7]*
  z[167]*(-1+2/(1+exp((Vsurface-xdotRToe)/par->ContactV0))) - FxRHeel - 
  FxRToe - q1*z[165] - q1*z[167] - par->ContactHeelX*z[34]*z[165] - par->ContactToeX*
  z[34]*z[167] - par->ContactY*z[35]*z[165] - par->ContactY*z[35]*z[167] - 
  par->ContactFric*q2*z[165]*(-1+2/(1+exp((Vsurface-xdotRHeel)/par->ContactV0))) - 
  par->ContactFric*q2*z[167]*(-1+2/(1+exp((Vsurface-xdotRToe)/par->ContactV0))) - 
  par->ContactFric*par->ContactHeelX*z[36]*z[165]*(-1+2/(1+exp((Vsurface-
  xdotRHeel)/par->ContactV0))) - par->ContactFric*par->ContactToeX*z[36]*
  z[167]*(-1+2/(1+exp((Vsurface-xdotRToe)/par->ContactV0))) - par->ContactFric*
  par->ContactY*z[37]*z[165]*(-1+2/(1+exp((Vsurface-xdotRHeel)/par->ContactV0))) - 
  par->ContactFric*par->ContactY*z[37]*z[167]*(-1+2/(1+exp((Vsurface-xdotRToe)/
  par->ContactV0)));
  dgrf_dq[20] = q1*z[199] + q1*z[202] + q2*z[204] + q2*z[206] + par->ContactHeelX*
  z[34]*z[199] + par->ContactHeelX*z[36]*z[204] + par->ContactHeelX*z[180]*
  FyRHeel + par->ContactToeX*z[34]*z[202] + par->ContactToeX*z[36]*z[206] + 
  par->ContactToeX*z[180]*FyRToe + par->ContactY*z[35]*z[199] + par->ContactY*
  z[35]*z[202] + par->ContactY*z[37]*z[204] + par->ContactY*z[37]*z[206] + 
  par->ContactY*z[181]*FyRHeel + par->ContactY*z[181]*FyRToe + par->ShankLen*
  z[18]*FxRHeel + par->ShankLen*z[18]*FxRToe + par->ThighLen*z[8]*FxRHeel + 
  par->ThighLen*z[8]*FxRToe - par->ContactHeelX*z[34]*FxRHeel - par->ContactToeX*
  z[34]*FxRToe - par->ContactY*z[35]*FxRHeel - par->ContactY*z[35]*FxRToe - 
  par->ShankLen*z[18]*z[199] - par->ShankLen*z[18]*z[202] - par->ShankLen*
  z[20]*z[204] - par->ShankLen*z[20]*z[206] - par->ShankLen*z[179]*FyRHeel - 
  par->ShankLen*z[179]*FyRToe - par->ThighLen*z[7]*z[204] - par->ThighLen*
  z[7]*z[206] - par->ThighLen*z[8]*z[199] - par->ThighLen*z[8]*z[202] - 
  par->ThighLen*z[177]*FyRHeel - par->ThighLen*z[177]*FyRToe;
  dgrf_dq[21] = q1*z[199] + q1*z[202] + q2*z[204] + q2*z[206] + par->ContactHeelX*
  z[34]*z[199] + par->ContactHeelX*z[36]*z[204] + par->ContactHeelX*z[180]*
  FyRHeel + par->ContactToeX*z[34]*z[202] + par->ContactToeX*z[36]*z[206] + 
  par->ContactToeX*z[180]*FyRToe + par->ContactY*z[35]*z[199] + par->ContactY*
  z[35]*z[202] + par->ContactY*z[37]*z[204] + par->ContactY*z[37]*z[206] + 
  ...
  z[7]*z[206] - par->ThighLen*z[8]*z[199] - par->ThighLen*z[8]*z[202] - 
  par->ThighLen*z[177]*FyRHeel - par->ThighLen*z[177]*FyRToe;
  dgrf_dq[22] = q1*z[240] + q1*z[243] + q2*z[245] + q2*z[247] + par->ContactHeelX*
  z[34]*z[240] + par->ContactHeelX*z[36]*z[245] + par->ContactHeelX*z[223]*
  FyRHeel + par->ContactToeX*z[34]*z[243] + par->ContactToeX*z[36]*z[247] + 
  par->ContactToeX*z[223]*FyRToe + par->ContactY*z[35]*z[240] + par->ContactY*
  z[35]*z[243] + par->ContactY*z[37]*z[245] + par->ContactY*z[37]*z[247] + 
  par->ContactY*z[225]*FyRHeel + par->ContactY*z[225]*FyRToe + par->ShankLen*
  z[229]*FxRHeel + par->ShankLen*z[229]*FxRToe - par->ContactHeelX*z[230]*
  FxRHeel - par->ContactToeX*z[230]*FxRToe - par->ContactY*z[231]*FxRHeel - 
  par->ContactY*z[231]*FxRToe - par->ShankLen*z[18]*z[240] - par->ShankLen*
  z[18]*z[243] - par->ShankLen*z[20]*z[245] - par->ShankLen*z[20]*z[247] - 
  par->ShankLen*z[222]*FyRHeel - par->ShankLen*z[222]*FyRToe - par->ThighLen*
  z[7]*z[245] - par->ThighLen*z[7]*z[247] - par->ThighLen*z[8]*z[240] - 
  par->ThighLen*z[8]*z[243];
  dgrf_dq[23] = q1*z[261] + q1*z[264] + q2*z[266] + q2*z[268] + par->ContactHeelX*
  z[34]*z[261] + par->ContactHeelX*z[35]*FyRHeel + par->ContactHeelX*z[36]*
  z[266] + par->ContactToeX*z[34]*z[264] + par->ContactToeX*z[35]*FyRToe + 
  par->ContactToeX*z[36]*z[268] + par->ContactY*z[35]*z[261] + par->ContactY*
  z[35]*z[264] + par->ContactY*z[37]*z[266] + par->ContactY*z[37]*z[268] + 
  par->ContactY*z[249]*FyRHeel + par->ContactY*z[249]*FyRToe - par->ContactHeelX*
  z[37]*FxRHeel - par->ContactToeX*z[37]*FxRToe - par->ContactY*z[253]*FxRHeel - 
  par->ContactY*z[253]*FxRToe - par->ShankLen*z[18]*z[261] - par->ShankLen*
  z[18]*z[264] - par->ShankLen*z[20]*z[266] - par->ShankLen*z[20]*z[268] - 
  par->ThighLen*z[7]*z[266] - par->ThighLen*z[7]*z[268] - par->ThighLen*z[8]*
  z[261] - par->ThighLen*z[8]*z[264];
  dgrf_dq[24] = 0;
  dgrf_dq[25] = 0;
  dgrf_dq[26] = 0;
  dgrf_dq[27] = 0;
  dgrf_dq[28] = par->ContactFric*(z[169]*(-1+2/(1+exp((Vsurface-xdotLHeel)/
  par->ContactV0)))+z[171]*(-1+2/(1+exp((Vsurface-xdotLToe)/par->ContactV0))));
  dgrf_dq[29] = -z[214] - z[216];
  dgrf_dq[30] = 0;
  dgrf_dq[31] = 0;
  dgrf_dq[32] = 0;
  dgrf_dq[33] = -z[214] - z[216];
  dgrf_dq[34] = -z[297] - z[299];
  dgrf_dq[35] = -z[318] - z[320];
  dgrf_dq[36] = 0;
  dgrf_dq[37] = -z[169] - z[171];
  dgrf_dq[38] = z[209] + z[212];
  dgrf_dq[39] = 0;
  dgrf_dq[40] = 0;
  dgrf_dq[41] = 0;
  dgrf_dq[42] = z[209] + z[212];
  dgrf_dq[43] = z[292] + z[295];
  dgrf_dq[44] = z[313] + z[316];
  dgrf_dq[45] = FyLHeel + FyLToe;
  dgrf_dq[46] = par->ShankLen*z[66]*z[169] + par->ShankLen*z[66]*z[171] + 
  par->ThighLen*z[56]*z[169] + par->ThighLen*z[56]*z[171] + par->ContactFric*
  par->ShankLen*z[68]*z[169]*(-1+2/(1+exp((Vsurface-xdotLHeel)/par->ContactV0))) + 
  par->ContactFric*par->ShankLen*z[68]*z[171]*(-1+2/(1+exp((Vsurface-xdotLToe)/
  par->ContactV0))) + par->ContactFric*par->ThighLen*z[55]*z[169]*(-1+2/(1+
  exp((Vsurface-xdotLHeel)/par->ContactV0))) + par->ContactFric*par->ThighLen*
  z[55]*z[171]*(-1+2/(1+exp((Vsurface-xdotLToe)/par->ContactV0))) - FxLHeel - 
  FxLToe - q1*z[169] - q1*z[171] - par->ContactHeelX*z[82]*z[169] - par->ContactToeX*
  z[82]*z[171] - par->ContactY*z[83]*z[169] - par->ContactY*z[83]*z[171] - 
  par->ContactFric*q2*z[169]*(-1+2/(1+exp((Vsurface-xdotLHeel)/par->ContactV0))) - 
  par->ContactFric*q2*z[171]*(-1+2/(1+exp((Vsurface-xdotLToe)/par->ContactV0))) - 
  par->ContactFric*par->ContactHeelX*z[84]*z[169]*(-1+2/(1+exp((Vsurface-
  xdotLHeel)/par->ContactV0))) - par->ContactFric*par->ContactToeX*z[84]*
  z[171]*(-1+2/(1+exp((Vsurface-xdotLToe)/par->ContactV0))) - par->ContactFric*
  par->ContactY*z[85]*z[169]*(-1+2/(1+exp((Vsurface-xdotLHeel)/par->ContactV0))) - 
  par->ContactFric*par->ContactY*z[85]*z[171]*(-1+2/(1+exp((Vsurface-xdotLToe)/
  par->ContactV0)));
  dgrf_dq[47] = q1*z[209] + q1*z[212] + q2*z[214] + q2*z[216] + par->ContactHeelX*
  z[82]*z[209] + par->ContactHeelX*z[84]*z[214] + par->ContactHeelX*z[185]*
  FyLHeel + par->ContactToeX*z[82]*z[212] + par->ContactToeX*z[84]*z[216] + 
  par->ContactToeX*z[185]*FyLToe + par->ContactY*z[83]*z[209] + par->ContactY*
  z[83]*z[212] + par->ContactY*z[85]*z[214] + par->ContactY*z[85]*z[216] + 
  par->ContactY*z[186]*FyLHeel + par->ContactY*z[186]*FyLToe + par->ShankLen*
  z[66]*FxLHeel + par->ShankLen*z[66]*FxLToe + par->ThighLen*z[56]*FxLHeel + 
  par->ThighLen*z[56]*FxLToe - par->ContactHeelX*z[82]*FxLHeel - par->ContactToeX*
  z[82]*FxLToe - par->ContactY*z[83]*FxLHeel - par->ContactY*z[83]*FxLToe - 
  par->ShankLen*z[66]*z[209] - par->ShankLen*z[66]*z[212] - par->ShankLen*
  z[68]*z[214] - par->ShankLen*z[68]*z[216] - par->ShankLen*z[184]*FyLHeel - 
  par->ShankLen*z[184]*FyLToe - par->ThighLen*z[55]*z[214] - par->ThighLen*
  z[55]*z[216] - par->ThighLen*z[56]*z[209] - par->ThighLen*z[56]*z[212] - 
  par->ThighLen*z[182]*FyLHeel - par->ThighLen*z[182]*FyLToe;
  dgrf_dq[48] = 0;
  dgrf_dq[49] = 0;
  dgrf_dq[50] = 0;
  dgrf_dq[51] = q1*z[209] + q1*z[212] + q2*z[214] + q2*z[216] + par->ContactHeelX*
  z[82]*z[209] + par->ContactHeelX*z[84]*z[214] + par->ContactHeelX*z[185]*
  FyLHeel + par->ContactToeX*z[82]*z[212] + par->ContactToeX*z[84]*z[216] + 
  par->ContactToeX*z[185]*FyLToe + par->ContactY*z[83]*z[209] + par->ContactY*
  z[83]*z[212] + par->ContactY*z[85]*z[214] + par->ContactY*z[85]*z[216] + 
  ...
  z[55]*z[216] - par->ThighLen*z[56]*z[209] - par->ThighLen*z[56]*z[212] - 
  par->ThighLen*z[182]*FyLHeel - par->ThighLen*z[182]*FyLToe;
  dgrf_dq[52] = q1*z[292] + q1*z[295] + q2*z[297] + q2*z[299] + par->ContactHeelX*
  z[82]*z[292] + par->ContactHeelX*z[84]*z[297] + par->ContactHeelX*z[275]*
  FyLHeel + par->ContactToeX*z[82]*z[295] + par->ContactToeX*z[84]*z[299] + 
  par->ContactToeX*z[275]*FyLToe + par->ContactY*z[83]*z[292] + par->ContactY*
  z[83]*z[295] + par->ContactY*z[85]*z[297] + par->ContactY*z[85]*z[299] + 
  par->ContactY*z[277]*FyLHeel + par->ContactY*z[277]*FyLToe + par->ShankLen*
  z[282]*FxLHeel + par->ShankLen*z[282]*FxLToe - par->ContactHeelX*z[283]*
  FxLHeel - par->ContactToeX*z[283]*FxLToe - par->ContactY*z[284]*FxLHeel - 
  par->ContactY*z[284]*FxLToe - par->ShankLen*z[66]*z[292] - par->ShankLen*
  z[66]*z[295] - par->ShankLen*z[68]*z[297] - par->ShankLen*z[68]*z[299] - 
  par->ShankLen*z[274]*FyLHeel - par->ShankLen*z[274]*FyLToe - par->ThighLen*
  z[55]*z[297] - par->ThighLen*z[55]*z[299] - par->ThighLen*z[56]*z[292] - 
  par->ThighLen*z[56]*z[295];
  dgrf_dq[53] = q1*z[313] + q1*z[316] + q2*z[318] + q2*z[320] + par->ContactHeelX*
  z[82]*z[313] + par->ContactHeelX*z[83]*FyLHeel + par->ContactHeelX*z[84]*
  z[318] + par->ContactToeX*z[82]*z[316] + par->ContactToeX*z[83]*FyLToe + 
  par->ContactToeX*z[84]*z[320] + par->ContactY*z[83]*z[313] + par->ContactY*
  z[83]*z[316] + par->ContactY*z[85]*z[318] + par->ContactY*z[85]*z[320] + 
  par->ContactY*z[301]*FyLHeel + par->ContactY*z[301]*FyLToe - par->ContactHeelX*
  z[85]*FxLHeel - par->ContactToeX*z[85]*FxLToe - par->ContactY*z[306]*FxLHeel - 
  par->ContactY*z[306]*FxLToe - par->ShankLen*z[66]*z[313] - par->ShankLen*
  z[66]*z[316] - par->ShankLen*z[68]*z[318] - par->ShankLen*z[68]*z[320] - 
  par->ThighLen*z[55]*z[318] - par->ThighLen*z[55]*z[320] - par->ThighLen*
  z[56]*z[313] - par->ThighLen*z[56]*z[316];
  dgrf_dqd[0] = -z[412] - z[413];
  dgrf_dqd[1] = -z[422] - z[423];
  dgrf_dqd[2] = -z[451] - z[453];
  dgrf_dqd[3] = -z[451] - z[453];
  dgrf_dqd[4] = -z[475] - z[477];
  dgrf_dqd[5] = -z[485] - z[487];
  dgrf_dqd[6] = 0;
  dgrf_dqd[7] = 0;
  dgrf_dqd[8] = 0;
  dgrf_dqd[9] = z[410] + z[411];
  dgrf_dqd[10] = z[420] + z[421];
  dgrf_dqd[11] = z[447] + z[449];
  dgrf_dqd[12] = z[447] + z[449];
  dgrf_dqd[13] = z[471] + z[473];
  dgrf_dqd[14] = z[481] + z[483];
  dgrf_dqd[15] = 0;
  dgrf_dqd[16] = 0;
  dgrf_dqd[17] = 0;
  dgrf_dqd[18] = q1*z[410] + q1*z[411] + par->ContactHeelX*z[34]*z[410] + 
  par->ContactToeX*z[34]*z[411] + par->ContactY*z[35]*z[410] + par->ContactY*
  z[35]*z[411] + q2*z[412] + q2*z[413] + par->ContactHeelX*z[36]*z[412] + 
  par->ContactToeX*z[36]*z[413] + par->ContactY*z[37]*z[412] + par->ContactY*
  z[37]*z[413] - par->ShankLen*z[18]*z[410] - par->ShankLen*z[18]*z[411] - 
  par->ThighLen*z[8]*z[410] - par->ThighLen*z[8]*z[411] - par->ShankLen*z[20]*
  z[412] - par->ShankLen*z[20]*z[413] - par->ThighLen*z[7]*z[412] - par->ThighLen*
  z[7]*z[413];
  dgrf_dqd[19] = q1*z[420] + q1*z[421] + par->ContactHeelX*z[34]*z[420] + 
  par->ContactToeX*z[34]*z[421] + par->ContactY*z[35]*z[420] + par->ContactY*
  z[35]*z[421] + q2*z[422] + q2*z[423] + par->ContactHeelX*z[36]*z[422] + 
  par->ContactToeX*z[36]*z[423] + par->ContactY*z[37]*z[422] + par->ContactY*
  z[37]*z[423] - par->ShankLen*z[18]*z[420] - par->ShankLen*z[18]*z[421] - 
  par->ThighLen*z[8]*z[420] - par->ThighLen*z[8]*z[421] - par->ShankLen*z[20]*
  z[422] - par->ShankLen*z[20]*z[423] - par->ThighLen*z[7]*z[422] - par->ThighLen*
  z[7]*z[423];
  dgrf_dqd[20] = q1*z[447] + q1*z[449] + par->ContactHeelX*z[34]*z[447] + 
  par->ContactToeX*z[34]*z[449] + par->ContactY*z[35]*z[447] + par->ContactY*
  z[35]*z[449] + q2*z[451] + q2*z[453] + par->ContactHeelX*z[36]*z[451] + 
  par->ContactToeX*z[36]*z[453] + par->ContactY*z[37]*z[451] + par->ContactY*
  z[37]*z[453] - par->ShankLen*z[18]*z[447] - par->ShankLen*z[18]*z[449] - 
  par->ThighLen*z[8]*z[447] - par->ThighLen*z[8]*z[449] - par->ShankLen*z[20]*
  z[451] - par->ShankLen*z[20]*z[453] - par->ThighLen*z[7]*z[451] - par->ThighLen*
  z[7]*z[453];
  dgrf_dqd[21] = q1*z[447] + q1*z[449] + par->ContactHeelX*z[34]*z[447] + 
  par->ContactToeX*z[34]*z[449] + par->ContactY*z[35]*z[447] + par->ContactY*
  z[35]*z[449] + q2*z[451] + q2*z[453] + par->ContactHeelX*z[36]*z[451] + 
  par->ContactToeX*z[36]*z[453] + par->ContactY*z[37]*z[451] + par->ContactY*
  z[37]*z[453] - par->ShankLen*z[18]*z[447] - par->ShankLen*z[18]*z[449] - 
  ...
  z[451] - par->ShankLen*z[20]*z[453] - par->ThighLen*z[7]*z[451] - par->ThighLen*
  z[7]*z[453];
  dgrf_dqd[22] = q1*z[471] + q1*z[473] + par->ContactHeelX*z[34]*z[471] + 
  par->ContactToeX*z[34]*z[473] + par->ContactY*z[35]*z[471] + par->ContactY*
  z[35]*z[473] + q2*z[475] + q2*z[477] + par->ContactHeelX*z[36]*z[475] + 
  par->ContactToeX*z[36]*z[477] + par->ContactY*z[37]*z[475] + par->ContactY*
  z[37]*z[477] - par->ShankLen*z[18]*z[471] - par->ShankLen*z[18]*z[473] - 
  par->ThighLen*z[8]*z[471] - par->ThighLen*z[8]*z[473] - par->ShankLen*z[20]*
  z[475] - par->ShankLen*z[20]*z[477] - par->ThighLen*z[7]*z[475] - par->ThighLen*
  z[7]*z[477];
  dgrf_dqd[23] = q1*z[481] + q1*z[483] + par->ContactHeelX*z[34]*z[481] + 
  par->ContactToeX*z[34]*z[483] + par->ContactY*z[35]*z[481] + par->ContactY*
  z[35]*z[483] + q2*z[485] + q2*z[487] + par->ContactHeelX*z[36]*z[485] + 
  par->ContactToeX*z[36]*z[487] + par->ContactY*z[37]*z[485] + par->ContactY*
  z[37]*z[487] - par->ShankLen*z[18]*z[481] - par->ShankLen*z[18]*z[483] - 
  par->ThighLen*z[8]*z[481] - par->ThighLen*z[8]*z[483] - par->ShankLen*z[20]*
  z[485] - par->ShankLen*z[20]*z[487] - par->ThighLen*z[7]*z[485] - par->ThighLen*
  z[7]*z[487];
  dgrf_dqd[24] = 0;
  dgrf_dqd[25] = 0;
  dgrf_dqd[26] = 0;
  dgrf_dqd[27] = -z[417] - z[418];
  dgrf_dqd[28] = -z[426] - z[427];
  dgrf_dqd[29] = -z[459] - z[461];
  dgrf_dqd[30] = 0;
  dgrf_dqd[31] = 0;
  dgrf_dqd[32] = 0;
  dgrf_dqd[33] = -z[459] - z[461];
  dgrf_dqd[34] = -z[501] - z[503];
  dgrf_dqd[35] = -z[511] - z[513];
  dgrf_dqd[36] = z[415] + z[416];
  dgrf_dqd[37] = z[424] + z[425];
  dgrf_dqd[38] = z[455] + z[457];
  dgrf_dqd[39] = 0;
  dgrf_dqd[40] = 0;
  dgrf_dqd[41] = 0;
  dgrf_dqd[42] = z[455] + z[457];
  dgrf_dqd[43] = z[497] + z[499];
  dgrf_dqd[44] = z[507] + z[509];
  dgrf_dqd[45] = q1*z[415] + q1*z[416] + par->ContactHeelX*z[82]*z[415] + 
  par->ContactToeX*z[82]*z[416] + par->ContactY*z[83]*z[415] + par->ContactY*
  z[83]*z[416] + q2*z[417] + q2*z[418] + par->ContactHeelX*z[84]*z[417] + 
  par->ContactToeX*z[84]*z[418] + par->ContactY*z[85]*z[417] + par->ContactY*
  z[85]*z[418] - par->ShankLen*z[66]*z[415] - par->ShankLen*z[66]*z[416] - 
  par->ThighLen*z[56]*z[415] - par->ThighLen*z[56]*z[416] - par->ShankLen*
  z[68]*z[417] - par->ShankLen*z[68]*z[418] - par->ThighLen*z[55]*z[417] - 
  par->ThighLen*z[55]*z[418];
  dgrf_dqd[46] = q1*z[424] + q1*z[425] + par->ContactHeelX*z[82]*z[424] + 
  par->ContactToeX*z[82]*z[425] + par->ContactY*z[83]*z[424] + par->ContactY*
  z[83]*z[425] + q2*z[426] + q2*z[427] + par->ContactHeelX*z[84]*z[426] + 
  par->ContactToeX*z[84]*z[427] + par->ContactY*z[85]*z[426] + par->ContactY*
  z[85]*z[427] - par->ShankLen*z[66]*z[424] - par->ShankLen*z[66]*z[425] - 
  par->ThighLen*z[56]*z[424] - par->ThighLen*z[56]*z[425] - par->ShankLen*
  z[68]*z[426] - par->ShankLen*z[68]*z[427] - par->ThighLen*z[55]*z[426] - 
  par->ThighLen*z[55]*z[427];
  dgrf_dqd[47] = q1*z[455] + q1*z[457] + par->ContactHeelX*z[82]*z[455] + 
  par->ContactToeX*z[82]*z[457] + par->ContactY*z[83]*z[455] + par->ContactY*
  z[83]*z[457] + q2*z[459] + q2*z[461] + par->ContactHeelX*z[84]*z[459] + 
  par->ContactToeX*z[84]*z[461] + par->ContactY*z[85]*z[459] + par->ContactY*
  z[85]*z[461] - par->ShankLen*z[66]*z[455] - par->ShankLen*z[66]*z[457] - 
  par->ThighLen*z[56]*z[455] - par->ThighLen*z[56]*z[457] - par->ShankLen*
  z[68]*z[459] - par->ShankLen*z[68]*z[461] - par->ThighLen*z[55]*z[459] - 
  par->ThighLen*z[55]*z[461];
  dgrf_dqd[48] = 0;
  dgrf_dqd[49] = 0;
  dgrf_dqd[50] = 0;
  dgrf_dqd[51] = q1*z[455] + q1*z[457] + par->ContactHeelX*z[82]*z[455] + 
  par->ContactToeX*z[82]*z[457] + par->ContactY*z[83]*z[455] + par->ContactY*
  z[83]*z[457] + q2*z[459] + q2*z[461] + par->ContactHeelX*z[84]*z[459] + 
  par->ContactToeX*z[84]*z[461] + par->ContactY*z[85]*z[459] + par->ContactY*
  z[85]*z[461] - par->ShankLen*z[66]*z[455] - par->ShankLen*z[66]*z[457] - 
  ...
  z[68]*z[459] - par->ShankLen*z[68]*z[461] - par->ThighLen*z[55]*z[459] - 
  par->ThighLen*z[55]*z[461];
  dgrf_dqd[52] = q1*z[497] + q1*z[499] + par->ContactHeelX*z[82]*z[497] + 
  par->ContactToeX*z[82]*z[499] + par->ContactY*z[83]*z[497] + par->ContactY*
  z[83]*z[499] + q2*z[501] + q2*z[503] + par->ContactHeelX*z[84]*z[501] + 
  par->ContactToeX*z[84]*z[503] + par->ContactY*z[85]*z[501] + par->ContactY*
  z[85]*z[503] - par->ShankLen*z[66]*z[497] - par->ShankLen*z[66]*z[499] - 
  par->ThighLen*z[56]*z[497] - par->ThighLen*z[56]*z[499] - par->ShankLen*
  z[68]*z[501] - par->ShankLen*z[68]*z[503] - par->ThighLen*z[55]*z[501] - 
  par->ThighLen*z[55]*z[503];
  dgrf_dqd[53] = q1*z[507] + q1*z[509] + par->ContactHeelX*z[82]*z[507] + 
  par->ContactToeX*z[82]*z[509] + par->ContactY*z[83]*z[507] + par->ContactY*
  z[83]*z[509] + q2*z[511] + q2*z[513] + par->ContactHeelX*z[84]*z[511] + 
  par->ContactToeX*z[84]*z[513] + par->ContactY*z[85]*z[511] + par->ContactY*
  z[85]*z[513] - par->ShankLen*z[66]*z[507] - par->ShankLen*z[66]*z[509] - 
  par->ThighLen*z[56]*z[507] - par->ThighLen*z[56]*z[509] - par->ShankLen*
  z[68]*z[511] - par->ShankLen*z[68]*z[513] - par->ThighLen*z[55]*z[511] - 
  par->ThighLen*z[55]*z[513];
